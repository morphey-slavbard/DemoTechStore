      ...
      <header className="sticky top-0 z-50 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#" className="text-slate-600 hover:text-slate-900 font-medium">Categories</a>
            <a href="#" className="text-slate-600 hover:text-slate-900 font-medium">New Arrivals</a>
            <a href="#" className="text-slate-600 hover:text-slate-900 font-medium">Best Sellers</a>
          </nav>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-lg">
                Explore our curated collection of cutting-edge electronics and devices. Premium quality at incredible prices.
              </p>
      ...
      <section className="bg-gradient-to-r from-amber-50 to-orange-50 py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">Featured Recommendations</h2>
            <a href="#" className="text-blue-600 hover:text-blue-700 font-semibold">View All →</a>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: "Wireless Headphones", price: "$199", image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=300&h=300&fit=crop" },
              { name: "Smart Watch", price: "$299", image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=300&h=300&fit=crop" },
              { name: "4K Camera", price: "$899", image: "https://images.unsplash.com/photo-1612198188060-c7c2a3b66eae?w=300&h=300&fit=crop" },
              { name: "Gaming Laptop", price: "$1,299", image: "https://images.unsplash.com/photo-1588872657840-218e412ee5ff?w=300&h=300&fit=crop" },
            ].map((product, idx) => (
              <div key={idx} className="group cursor-pointer">
                ...
                <h3 className="text-lg font-semibold text-slate-900 group-hover:text-blue-600 transition">{product.name}</h3>
                <p className="text-xl font-bold text-slate-700 mt-2">{product.price}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 sm:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">Shop by Category</h2>
            ...
            {[
              {
                ...
                icon: "💻",
                image: "https://images.unsplash.com/photo-1588872657840-218e412ee5ff?w=500&h=400&fit=crop"
              },
              {
                name: "Televisions",
                ...
                icon: "📺",
                image: "https://images.unsplash.com/photo-1593642632459-44953f545f96?w=500&h=400&fit=crop"
              },
              {
                name: "Smartphones",
                description: "Latest flagship models with cutting-edge features",
              ...
              {
                name: "Wearables",
                description: "Smartwatches and fitness trackers for your lifestyle",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              { icon: Award, label: "2-Year Warranty", desc: "Comprehensive coverage" },
              { icon: Zap, label: "Fast Delivery", desc: "24/48 hour delivery" },
              { icon: ShoppingCart, label: "Easy Returns", desc: "30-day return policy" },
            ].map((item, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm">Your trusted source for premium electronics and gadgets.</p>
            </div>
            <div>
